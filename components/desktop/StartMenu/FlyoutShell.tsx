    ...
    >
      {compact && (
        <button
          type="button"
          onClick={onClose}
          className="hover:bg-xp-selection sticky top-0 z-10 flex w-full items-center gap-2 border-b border-[#c8c4b4] bg-[#ece9d8] px-3 py-2 text-left text-[12px] font-bold hover:text-white"
        >
